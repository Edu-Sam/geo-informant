...
class PasswordOTP extends StatefulWidget{
  PasswordOTP({Key? key,required this.email}): super(key: key);
  String email;

  @override
  PasswordOTPState createState()=> PasswordOTPState();

}

class PasswordOTPState extends State<PasswordOTP>{
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextButton(
                              child: Text('Send OTP',style: TextStyle(color: AppConstants.primaryColor,
                              ...
                              onPressed: () async{
                                if(form_key.currentState!.validate()){
                                  ...
                                  await verifyOTP(otp_controller.text,widget.email, types.elementAt(current_value!)).then((value){
                                    setState(() {
                                      isLoading=false;
                                    });
                                    if(value is int){
  ...
  Future<dynamic> verifyOTP(String otp,String email,String user_type) async{
    var result= await detailsRepository.verifyOTP(otp,email, user_type);
    return result;
  }
