...
class TenantStatus extends StatefulWidget{
  TenantStatus({Key? key,required this.isClear,required this.national_id,
  ...
  @override
  _TenantStatuState createState()=> _TenantStatuState();
}

class _TenantStatuState extends State<TenantStatus>{
               ...
               Column(
                 children: [
                   ...
                   Padding(
                     ...
                     child: Text('You dont have any reports listed\n'
                         'with GeoInformant.',textAlign: TextAlign.center,style: TextStyle(
                       color: Colors.grey,
                       fontSize: 20,
                 ...
                 children: [
                   ...
                   Padding(
                     padding: EdgeInsets.only(top: 30.0,left: 20.0),
                     child: Text('You have ${widget.reports.toString()} report(s) listed\n'
                         'with GeoInformant.',textAlign: TextAlign.center,style: TextStyle(
                       color: Colors.grey,
                       fontSize: 20,
                       fontWeight: FontWeight.w500,
